...
public class Player extends Entity{
    ...
    public void pickUpObject(int i) {
    	...
    	if(i != 999) {
    		...
    		switch(objectName) {
    		case "Key": gp.playSE(1); hasKey++; gp.obj[i] = null; gp.ui.showMessage("You got a key!"); break;
    		...
    		case "Boots": gp.playSE(2); speed += 4; gp.obj[i] = null; gp.ui.showMessage("Speed up!"); break;
